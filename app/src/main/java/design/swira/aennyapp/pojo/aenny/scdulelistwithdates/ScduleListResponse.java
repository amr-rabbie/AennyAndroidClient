...
public class ScduleListResponse{
	...
	@SerializedName("Count_Trip_Schedule_Id")
	private int countTripScheduleId;
	...
	public void setCountTripScheduleId(int countTripScheduleId){
		this.countTripScheduleId = countTripScheduleId;
	}

	public int getCountTripScheduleId(){
		return countTripScheduleId;
	}
	...
	public void setTripDuration(Object tripDuration){
		this.tripDuration = tripDuration;
	}

	public Object getTripDuration(){
		return tripDuration;
	}
	...
	@Override
 	public String toString(){
		return 
			...
			",count_Trip_Schedule_Id = '" + countTripScheduleId + '\'' + 
			",trip_Time = '" + tripTime + '\'' + 
